...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab1_3.setGeometry(QtCore.QRect(0, 40, 551, 511))
        ...
        self.ind_targetinput.setGeometry(QtCore.QRect(120, 0, 331, 20))
        ...
        self.ind_typeOfPortScan.setGeometry(QtCore.QRect(130, 70, 171, 31))
        ...
        self.Targetlabel_2.setGeometry(QtCore.QRect(10, 0, 71, 21))
        ...
        self.portlabel_2.setGeometry(QtCore.QRect(10, 30, 81, 21))
        self.portlabel_2.setObjectName("portlabel_2")
        self.full_ScanButton = QtWidgets.QPushButton(self.frame_6)
        self.full_ScanButton.setGeometry(QtCore.QRect(230, 60, 75, 23))
        ...
        self.Outputlabel_2.setGeometry(QtCore.QRect(20, 90, 501, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(10)
        font.setUnderline(True)
        ...
        self.label_7.setGeometry(QtCore.QRect(20, 10, 521, 16))
        ...
        self.SingSchScanSchBtn = QtWidgets.QPushButton(self.tab_3)
        self.SingSchScanSchBtn.setGeometry(QtCore.QRect(10, 140, 181, 31))
        self.SingSchScanSchBtn.setObjectName("SingSchScanSchBtn")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ind_typeOfPortScan.setItemText(2, _translate("MainWindow", "Quick Scan"))
        self.ind_typeOfPortScan.setItemText(3, _translate("MainWindow", "Quic Scan ++"))
        self.tab1_3.setTabText(self.tab1_3.indexOf(self.individualScanTab), _translate("MainWindow", "Individual Scan"))
        self.Targetlabel_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Target :</span></p></body></html>"))
        self.portlabel_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Port :</span></p></body></html>"))
        ...
        self.tab1_3.setTabText(self.tab1_3.indexOf(self.FullScanTab), _translate("MainWindow", "Full Scan"))
        ...
        self.SingSchScanSchBtn.setText(_translate("MainWindow", "Schedule"))
